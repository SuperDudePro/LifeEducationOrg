...
import bodyImage5 from "./images/body-image-5.webp";
import bodyImage6 from "./images/body-image-6.webp";
...
const post: LifeEducationPost = {
  ...
  body: (
    <>
      ...
      <PostFigure
        src={bodyImage1}
        alt="A polished AI-generated 10 is contrasted with a student doing the rough work of moving from 1 to 3."
      />

      <h2>What the conversation actually is</h2>
      ...
      <PostFigure
        src={bodyImage2}
        alt="A student explains their thinking while a teacher listens, with tangled ideas resolving into a clearer green structure."
      />

      <h2>Then we blamed the tool</h2>
      ...
      <p>
        Generative AI has made it easy enough to produce work you don't understand that some professors and colleges are moving back toward <a href="https://education.uiowa.edu/october-2025-spotlight-assessment-and-continuous-improvement" target="_blank" rel="noreferrer">handwritten, in-person exams</a>. Meanwhile <a href="https://aiinteaching.caltech.edu/" target="_blank" rel="noreferrer">other universities are warning faculty that AI detectors aren't reliable enough</a> to treat as evidence of cheating. So we have a technology that can explain a hard idea six different ways at midnight, and one of our answers is the little paper booklet.
      </p>
      ...
      <PostFigure
        src={bodyImage3}
        alt="A timed paper exam is contrasted with a teacher-student conversation that reveals understanding."
      />

      <h2>Fake learning is not a new product</h2>
      ...
      <h2>The number was never what we said it was</h2>
      ...
      <PostFigure
        src={bodyImage4}
        alt="A green 82 sits inside a web of rubrics, point values, and measurement marks that suggest false precision."
      />

      <h2>"But then how do we rank them?"</h2>
      ...
      <PostFigure
        src={bodyImage5}
        alt="Learners starting from different places move toward the same green minimum capability floor."
      />

      <h2>It's easy because I built it to be easy</h2>
      ...
      <PostFigure
        src={bodyImage6}
        alt="A teacher circulates during class, pausing for quick conversations that check student understanding while work is underway."
      />

      <h2>I'm not offering a fix</h2>
      ...
      <p>
        If you're working through this in your own classroom, school or house, I want to hear one thing in particular: how are you figuring out what the learner actually owns once AI has touched the work? <a className="why-button" href="/contact">Send me a note</a>.
      </p>
